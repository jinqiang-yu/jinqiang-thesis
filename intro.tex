...
%  [87, 302, 307, 378]
%
Moreover, significant milestones have been achieved in the \newm{field} of reinforcement learning, 
...
\newm{
Although these accomplishments highlight the potential of ML and AI, they also emphasize the importance of trustworthy AI~\cite{wing-cacm21,trustai-acmc23,kurd-csur22,sss-cacm22,ms-rw22,msi-fai23}.
%
Ensuring transparency is crucial to guarantee the 
positive effects of these technologies.
}
...
In light of the identified critical issues in ML
\newm{and driven by recent proposals for regulating 
ML/AI systems~\cite{euaiact21,unesco21,vg-nmi21,radem-rai20},
as well as existing recommendations~\cite{hlegai20,oecd21},}
...
\begin{itemize}
	...
	\item \emph{Post-hoc} methods explain trained ML models by applying interpretation
		...
		%
		\newm{Post-hoc methods can be further categorized into two model-agnostic and model
		specific techniques:}
...
\newm{
studies~\cite{rai-jams20,darwiche-lics23,ignatiev-ijcai20,ms-rw22,msi-fai23} and
surveys~\cite{asjaa-dmkd21,molnar-bk20,xudfzz-nlpcc19,hsmbs-xxai22}.}
