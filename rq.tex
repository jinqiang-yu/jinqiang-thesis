...
%
\newm{The proposed approach can be applied in the context of entire feature space or a set of
	training instances.}
%
...
i.e. \newm{hidden} correlations between features, to generate more concise "why" formal explanations
...
the \newm{earlier} formal approaches also fail to provide feature attribution.
...
We propose a method to apply formal explainability in a just-in-time (JIT) defect prediction.
%
...
%
\newm{However, JIT defect prediction largely remains a black-box, with predictions that are neither explainable nor actionable for practitioners. 
%
Although previous studies have applied various model-agnostic methods to provide explanations
for the predictions made by JIT models,
these explanations are still not formally sound, robust, or actionable.}
%
